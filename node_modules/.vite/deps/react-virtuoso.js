...
function systemToComponent(systemSpec, map2, Root) {
  ...
  const useEmitterValue2 = import_react.default.version.startsWith("18") ? useEmitterValue18 : useEmitterValueLegacy;
...
var Viewport$2 = ({ children }) => {
  ...
  return import_react.default.createElement("div", { style: viewportStyle(alignToBottom), ref: viewportRef, "data-viewport-type": "element" }, children);
};
var WindowViewport$2 = ({ children }) => {
  ...
  return import_react.default.createElement("div", { ref: viewportRef, style: viewportStyle(alignToBottom), "data-viewport-type": "window" }, children);
};
var TopItemListContainer = ({ children }) => {
  ...
  const context = useEmitterValue$2("context");
  return import_react.default.createElement(TopItemList, { style, ...contextPropIfNotDomElement(TopItemList, context) }, children);
};
...
var Viewport$1 = ({ children }) => {
  ...
  return import_react.default.createElement("div", { style: viewportStyle(false), ref: viewportRef }, children);
};
var WindowViewport$1 = ({ children }) => {
  ...
  return import_react.default.createElement("div", { ref: viewportRef, style: viewportStyle(false) }, children);
};
...
var Viewport = ({ children }) => {
  ...
  return import_react.default.createElement("div", { style: viewportStyle(false), ref: viewportRef, "data-viewport-type": "element" }, children);
};
var WindowViewport = ({ children }) => {
  ...
  return import_react.default.createElement("div", { ref: viewportRef, style: viewportStyle(false), "data-viewport-type": "window" }, children);
};
